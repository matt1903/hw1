...
<html>
    <head>
        <link rel = "stylesheet" href = "index_arduino.css">
        ...
        <script defer src = 'index_arduino.js'></script>
        <meta charset = 'utf-8'>
    </head> 
    <body>
        <div>
                    ...
                    <div class = 'first-level-nav'>
                        ...
                        <div class = 'first-menu-right'>
                            ...
                            <div class = 'cloud-module'>
                                <a>                     <!--Immagine cloud da google fonts-->                    
        ...
        <div id = 'root'>
            <div id = 'homepage-container'>
                <aside class = 'left-aside'>
                    <div class = 'what-arduino'>
                        <h1>WHAT IS ARDUINO?</h1>
                        <img src = 'Immagini/arduinoUno.png' id = 'arduOG'>
                    </div>

                    <div class = 'options'>
                        <a class = 'store'>
                            <span>BUY AN ARDUINO</span>
                            <span class="material-symbols-outlined">shopping_cart</span>
                        </a>
                        <a class = 'learn-arduino'>
                            <span>LEARN ARDUINO</span>
                        ...
                        <a class = 'arduino-in-cloud'>
                            <span>ARDUINO IN THE CLOUD</span>
                    ...
                    <div class = 'banners'>
                        ...
                        <a class = 'arduino-edu'>
                            <div class = 'edu-text'>
                                <div>Redefining the Learning</div>
                                <div>Experience One Classroom</div>
                                <div>at a Time</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class = 'tail-block'>
                        <div class = 'title'>
                            <span>SHOW OFF YOUR</span>
                            <span>ARDUINO PROJECT</span>
                        </div>
                        <div class = 'text'>
                            Do you have a cool project you'd like to have featured on our social media channels?
                            <a>Share a tutorial</a> 
                    ...
                    <div class = 'tail-block'>
                        ...
                        <div class = 'text'>
                            ...
                            Have questions? The official multi-language
                            <a>Forum</a>     
                            is the place to go. Check out of the
                            <a>Playground</a> 
                            for a collection of Arduino knowledge, tutorials, and tips provided by your fellow Arduino users. 
                            For information on the development of Arduino, see the
                            <a>Arduino project on GitHub</a>
                        </div>
                    </div>
                    <!-- blocco che contiene delle informazioni sulla parte sinistra della pagina -->
                    <div class = 'tail-block'>
                        <div class = 'title'>
                    ...
                    <!-- lista dei collegamenti ai social con relative icone -->
                    <div id = 'social-list'>
                        <div class = 'twitter'>
                            <a>
                                <img src= "/Icone/X_logo.svg">
                                <span>on X</span>
                            </a>
                        </div>
                        <div class = 'facebook'>
                            <a>
                                <img src = "/Icone/facebook_logo.svg">
                                <span>on Facebook</span>
                            </a>
                        </div>
                        <div class = 'youtube'>
                            <a>
                                <img src = "Icone/youtube_logo.svg">
                                <span>on YouTube</span>
                            </a>
                        </div>
                        <div class = 'instagram'>
                            <a>
                                <img src = "Icone/instagram_logo.svg">
                                <span>on Instagram</span>
                            </a>
                        </div>
                        <div class = 'linkedin'>
                            <a>
                                <img src = "Icone/linkedin_logo.svg">
                                <span>on LinkedIn</span>
                            </a>
                        </div>
                        <div class = 'github'>
                            <a>
                                <img src = "Icone/github_logo.svg">
                                <span>on GitHub</span>
                            </a>
                        </div>
                    </div>
                    
                    <!-- Techy API button, mostra una stringa che suona molto tecnologica -->
                    <div id = 'techy-api'>
                        <button id = 'api-button'>
                            PREMERE QUI PER GENERARE UN TECHY-TEXT!
                            SOUND TECNOLOGIC
                        </button>
                        <section id = 'append-p'></section>
                    </div>
                    
                </aside>
                <div class = 'main-section'>
                    <div class = 'item-banner'>
                        <a><div id = 'free-div'><span class = 'clickedText'>Clicca per Scoprire di più!</span><img src = 'Immagini/Arduino-free-trial.jpg' id = 'free-trial-img'><div id = 'hidden-ds'></div></div></a>     <!--Dentro 'a' ci andranno i link alle future pagine-->
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/tiny-footprintf.jpg'></div></a>
                    </div>  
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/Homepage-PLC.jpg'></div></a>     
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/arduino_unoR4.jpg'></div></a>
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/arduino-sciencekit.png'></div></a>
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/arduino_alvik.jpg'></div></a>
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/hat_carrier.jpg'></div></a>
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/stepup_game.jpg'></div></a>
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/nano33.jpg'></div></a>
                    </div>
                    <div class = 'item-banner'>
                        <a><div><img src = 'Immagini/explore.png'></div></a>
                    </div>
                </div>
