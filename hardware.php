    ...
    <body>
        ...
        <div id = 'root'>
            <div id = 'side-bar'>
                ...
                <ul id = 'side-list'>
                    <li class = 'option-list'><a href = "#kits">Kits</a></li>
                    <li class = 'option-list'><a href = "#missNvis">Nano Family</a></li>
                    <li class = 'option-list'><a href = "#missNvis">MKR Family</a></li>
                    <li class = 'option-inner-list'><a href = "#edu">Boards</a></li>
                    <li class = 'option-inner-list'><a href = "#pro">Shields</a></li>
                    <li class = 'option-list'><a href = "#ardu-team">Classic Family</a></li>
                    <li class = 'option-inner-list'><a href = "#founders">Boards</a></li>
                    <li class = 'option-inner-list'><a href = "#menage-team">Shields</a></li>
                    <li class = 'option-list'><a href = "#tech-part">Mega Family</a></li>
                    <li class = 'option-list'><a href = "#tech-part">Retired</a></li>
                </ul>
            </div>

            <div id = 'main-content'>
                <h1 id = 'about-ardu' class = 'main-title'>Arduino Hardware</h1>
                    <p>Arduino has over the years released over 100 hardware products: boards, shields, carriers, kits and other accessories. In this page, you will find an overview of all active Arduino hardware, including the Nano, MKR and Classic families.</p>
                    <p><a href = "index_arduino.php"><img src = Immagini/Hardware/pro.jpg class = 'link-img'></a></p>
                    <p><a href = "index_arduino.php"><img src = Immagini/Hardware/education.jpg class = 'link-img'></a></p>
                <h2 id = 'kits' class = 'h2-title'>Kits</h2>
                    <p>Kits are a great way to get started with Arduino. The classic Starter Kit includes an Arduino UNO R3, a large set of electronic components, and a physical book with 15 chapters to help you get started.</p>
                    <p>The Oplà IoT Kit includes the components needed to build amazing IoT projects, and the Sensor Kit includes a set of great plug-and-play sensors and actuators. These kits also have their own dedicated content platform, with several cool projects to follow step by step.</p>
                    <table id = "kits-table">
                        <tr>
                            <td><img src = "Immagini/Hardware/starter-kit.jpg"></td>
                            <td><img src = "Immagini/Hardware/opla-iot-kit.jpg"></td>
                            <td><img src = "Immagini/hardware/sensor-kit.jpg"></td>
                        </tr>
                        <tr>
                            <td><span class = "dsc-span">Arduino Starter Kit</span></td>
                            <td><span class = "dsc-span">Arduino Oplà Iot Kit</span></td>
                            <td><span class = "dsc-span">Arduino Sensor Kit</span></td>
                        </tr>
                    </table>
                <h2 id = 'nano' class = 'h2-title'>Nano Family</h2>
                    <p>The Nano Family is a set of boards with a tiny footprint, packed with features. It ranges from the inexpensive, basic Nano Every, to the more feature-packed Nano 33 BLE Sense / Nano RP2040 Connect that has Bluetooth® / Wi-Fi® radio modules. These boards also have a set of embedded sensors, such as temperature/humidity, pressure, gesture, microphone and more. They can also be programmed with MicroPython and supports Machine Learning.</p>
                    <p>Want to know more about the Nano Family? Click the link below to discover all boards in more detail, along with a comparison table!</b></p>
                    <table>
                        <tr>
                            <td><img src = "Immagini/Hardware/Nano/nano-33-iot.jpg"></td>
                            <td><img src = "Immagini/hardware/Nano/nano-ble-sense.jpg"></td>
                            <td><img src = "Immagini/Hardware/Nano/nano-esp32.jpg"></td>
                            <td><img src = "Immagini/Hardware/Nano/nano-rp2040-connect.jpg"></td>
                        </tr>
                        <tr>
                            <td><span class = "dsc-span">Arduino Nano 33 IoT</span></td>
                            <td><span class = "dsc-span">Arduino Nano BLE Sense</span></td>
                            <td><span class = "dsc-span">Arduino Nano ESP32</span></td>
                            <td><span class = "dsc-span">Arduino Nano RP2040 Connect</span></td>
                        </tr>
                    </table>
                <h2 id = 'edu' class = 'h2-title'>MKR Family</h2>
                    <p>The MKR Family is a series of boards, shields & carriers that can be combined to create amazing projects without any additional circuitry. Each board is equipped with a radio module (except MKR Zero), that enables Wi-Fi®, Bluetooth®, LoRa®, Sigfox®, NB-IoT communication. All boards in the family are based on the Arm® Cortex®-M0 32-bit SAMD21 low power processor, and are equipped with a crypto chip for secure communication.</p>
                    <p>The MKR Family shields & carriers are designed to extend the functions of the board: such as environmental sensors, GPS, Ethernet, motor control and RGB matrix.</p>
                <h3 id = 'boards' class = 'h3-title'>Boards</h3>
                <table>
                    <tr>
                        <td><img src = "Immagini/Hardware/Nano/nano-33-iot.jpg"></td>
                        <td><img src = "Immagini/hardware/Nano/nano-ble-sense.jpg"></td>
